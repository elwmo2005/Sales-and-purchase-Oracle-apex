...
@@application/shared_components/files/tafqeet_sql.sql
@@application/shared_components/files/tafqeet11_js.sql
@@application/shared_components/files/convertnumbertoarabicwords_js.sql
...
@@application/shared_components/logic/application_items/a04.sql
@@application/shared_components/logic/application_items/a05.sql
@@application/shared_components/logic/application_items/a06.sql
@@application/shared_components/logic/application_items/a07.sql
...
@@application/shared_components/logic/application_computations/a04.sql
@@application/shared_components/logic/application_computations/a05.sql
@@application/shared_components/logic/application_computations/a06.sql
@@application/shared_components/logic/application_computations/a07.sql
@@application/shared_components/logic/application_settings.sql
@@application/shared_components/navigation/tabs/standard.sql
@@application/shared_components/navigation/tabs/parent.sql
@@application/shared_components/user_interface/lovs/class_list.sql
@@application/shared_components/user_interface/lovs/customers.sql
@@application/shared_components/user_interface/lovs/dealers_list.sql
@@application/shared_components/user_interface/lovs/dealer_type.sql
@@application/shared_components/user_interface/lovs/dept_list.sql
@@application/shared_components/user_interface/lovs/doc_type.sql
@@application/shared_components/user_interface/lovs/emp_list.sql
@@application/shared_components/user_interface/lovs/jobs_list.sql
@@application/shared_components/user_interface/lovs/login_remember_username.sql
@@application/shared_components/user_interface/lovs/sanfs.sql
@@application/shared_components/user_interface/lovs/store_list.sql
@@application/shared_components/user_interface/lovs/suppliers_list.sql
@@application/shared_components/user_interface/lovs/units_list.sql
@@application/shared_components/user_interface/lovs/الحالة.sql
@@application/shared_components/user_interface/lovs/نوع_الدفع.sql
@@application/shared_components/user_interface/lovs/نوع_تحصيل.sql
...
@@application/shared_components/security/authentications/authenticate_user.sql
...
@@application/deployment/install/install_data_base_install.sql
